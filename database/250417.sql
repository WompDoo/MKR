...
--
-- Host: 127.0.0.1
-- Loomise aeg: Aprill 25, 2017 kell 09:40 EL
...
(1, 'Twisted Cupboard', 'Furniture', 'This is a very artsy cupboard.', '301.95', 4, 'TC102'),
(2, 'Dark Table', 'Furniture', 'This is a very pretty table', '124.32', 1, 'DT01'),
(3, 'Cute Riiul\r\n', 'Furniture', 'This is a nice corner riiul', '80.93', 5, 'CR02'),
(4, 'Baby bed', 'Furniture', 'Babis can sleep here', '120.33', 3, 'BB12'),
(5, 'Etch a Sketch', 'Sketchbooks', 'Njau njau', '30.15', 1, 'SK11'),
(6, 'The Dunner', 'Woodturning', 'This is The Fatal Dunner.', '193.00', 3, 'WT01'),
(8, 'thingy', 'Furniture', 'lalal', '3.00', 0, 'FUR002');
...
(11, 5, 'book', '/MKR/img/markmik.jpg'),
(12, 6, 'dunner', '/MKR/img/kurikas.jpg'),
(13, 8, 'lala', '/MKR/img/google.png');
...
--
ALTER TABLE `productimage`
  MODIFY `productimage_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
